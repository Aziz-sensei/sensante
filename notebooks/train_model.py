...
# Preparation des données et de la cible

# Convertir les colonnes numériques (au cas où elles sont lues comme str)
cols_numeriques = ['age', 'temperature', 'tension_sys', 'toux', 'fatigue', 'maux_tete']
